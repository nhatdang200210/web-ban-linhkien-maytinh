...
$sql_lietke_donhang = "SELECT *, DATE_FORMAT(tbl_cart.thoigiandathang, '%d-%m-%Y') AS ngay 
    ...
    WHERE tbl_cart.cart_status = 1 AND tbl_cart.giao = 1
    ...
    <div class="menu_dh">
        <nav class="navbar navbar-light bg-light" style="margin-bottom:0;  padding-left:0">
            <form class="container-fluid justify-content-start" style="flex-wrap: nowrap; text-align:center">
                <a href="index.php?action=quanlydonhang&query=donmoi" class="task1"><button class="btn btn-outline-success me-2 " type="button">Đơn mới (<?php echo $donmoi ?>)</button></a>
                ...
                <a href="index.php?action=quanlydonhang&query=dagiao" class="task3"><button class="btn btn-outline-success me-2 <?php echo ($current_page == 'dagiao') ? 'active' : 'dagiao'; ?>" type="button">Đã giao</button></a>
            </form>
        </nav>
    </div>
    <div class="table-responsive">
        <table class="table table-hover table-bordered" style="text-align: center; font-size:18px">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td style="vertical-align: middle;">
                            <span style="color: green;">Đã giao thành công</span>
                        </td>

                        <td style="text-align: center; padding:4px; vertical-align: middle;">
                            <button class="xemdon_moi">
                                <a href="index.php?action=quanlydonhang&query=xemdonhang&madon=<?php echo $row['id_cart'] ?> " style="color:black">Xem đơn hàng</a>
                            </button>
                        </td>
                    </tr>
                <?php
