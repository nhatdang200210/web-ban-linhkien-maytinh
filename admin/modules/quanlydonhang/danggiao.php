...
$sql_lietke_donhang = "SELECT *, DATE_FORMAT(tbl_cart.thoigiandathang, '%d-%m-%Y') AS ngay 
    ...
    WHERE tbl_cart.cart_status = 1  AND tbl_cart.giao = 0
    ...
    <div class="menu_dh">
        <nav class="navbar navbar-light bg-light" style="margin-bottom:0;  padding-left:0">
            <form class="container-fluid justify-content-start" style="flex-wrap: nowrap; text-align:center">
                ...
                <a href="index.php?action=quanlydonhang&query=danggiao" class="task2"><button class="btn btn-outline-success me-2 <?php echo ($current_page == 'danggiao') ? 'active' : 'danggiao'; ?>" type="button">Đang giao (<?php echo $danggiao ?>)</button></a>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td style="vertical-align: middle;">
                            <?php
                            echo '<a style="color:black">Đang xử lý giao hàng</a>';
