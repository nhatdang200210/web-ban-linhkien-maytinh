    ...
    <div class="menu-donmua">
        <nav class="navbar navbar-light bg-light">
            <form class="container-fluid justify-content-start" style="flex-wrap: nowrap; text-align:center">
                <a href="index.php?quanly=donmua" style="width:20%"><button class="btn btn-outline-success me-2 <?php echo ($current_page == 'donmua') ? 'active' : ''; ?>" type="button">Tất cả đơn</button></a>
                <a href="index.php?quanly=dangxuly" style="width:20%" class="none"><button class="btn btn-outline-success me-2 <?php echo ($current_page == 'dangxuly') ? 'active' : ''; ?>" type="button"><i class="fa-solid fa-clock"></i> Chờ xử lý</button></a>
                <a href="index.php?quanly=dangxuly" style="width:20%" class="unnone"><button class="btn btn-outline-success me-2 <?php echo ($current_page == 'dangxuly') ? 'active' : ''; ?>" type="button"><i class="fa-solid fa-clock"></i> Đang chờ</button></a>
                <a href="index.php?quanly=danggiao" style="width:20%"><button class="btn btn-outline-success me-2" type="button"><i class="fa-solid fa-truck-fast"></i> Đang giao</button></a>
                        ...
                        <td style="vertical-align: middle;">
                            ...
                            <div class="tg_don_block" style="text-align: center;">
                                ...
                                <?php if ($row['cart_status'] == 0) {
                                    ...
                                    echo '<a href="pages/main/donmua/xulynguoinhan.php?madon=' . $row['id_cart'] . '">
