    ...
    <div class="menu-donmua">
        <nav class="navbar navbar-light bg-light">
            <form class="container-fluid justify-content-start" style="flex-wrap: nowrap; text-align:center">
                ...
                <a href="index.php?quanly=dagiao" style="width:20%"><button class="btn btn-outline-success me-2 <?php echo ($current_page == 'dagiao') ? 'active' : ''; ?>" type="button"><i class="fa-solid fa-square-check"></i> Hoàn thành</button></a>
    ...
    <div class="dondadat">
        ...
        if (isset($_SESSION['dangky'])) {
            ...
            $sql_lietke_donhang = "SELECT * FROM tbl_cart,tbl_nguoinhan
                                    ...
                                    AND tbl_nguoinhan.id_nguoinhan=tbl_cart.id_nguoinhan AND tbl_cart.cart_status = 1 AND tbl_cart.giao = 1
                    ...
                    <tr>
                        <th scope="col" colspan="3" class="afk">
                            <div style="width:58%; padding-left: 10px;">
                                ...
                                <div style=" opacity:0.6; line-height: 1.5;"><?php echo $soluong_sp ?> sản phẩm
                                    <?php
