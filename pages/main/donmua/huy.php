    ...
    <div class="menu-donmua">
        <nav class="navbar navbar-light bg-light">
            <form class="container-fluid justify-content-start" style="flex-wrap: nowrap; text-align:center">
                ...
                <a href="index.php?quanly=huy" style="width:20%"><button class="btn btn-outline-success me-2 <?php echo ($current_page == 'huy') ? 'active' : ''; ?>" type="button"><i class="fa-solid fa-file-circle-xmark"></i> Đã huỷ</button></a>
            </form>
        </nav>
    </div>
    ...
    <div class="dondadat">
        ...
        if (isset($_SESSION['dangky'])) {
            ...
            $sql_lietke_donhang = "SELECT * FROM tbl_cart,tbl_nguoinhan
                                    ...
                                    AND tbl_nguoinhan.id_nguoinhan=tbl_cart.id_nguoinhan AND tbl_cart.cart_status = 2
            ...
            <table class="table" style=" background-color:rgba(208, 234, 245, 0.367); border-radius: 10px">
                ...
                <tbody>
                    <tr style="font-size:17px">
                        ...
                        <td style="vertical-align: middle; width:22%" class="httt_don">
                            <?php
                            echo '<b style="color:#F74006">Đã huỷ đơn</b>';
